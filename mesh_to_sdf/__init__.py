...
def sample_sdf_near_surface(mesh, pointsHull, number_of_points=500000, surface_point_method='scan',
                            sign_method='normal', scan_count=100, scan_resolution=400, sample_point_count=10000000,
                            normal_sample_count=11, min_size=0):
    ...
    return surface_point_cloud.sample_sdf_near_surface(pointsHull, number_of_points, surface_point_method == 'scan',
                                                       sign_method, normal_sample_count, min_size)
